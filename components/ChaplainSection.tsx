  ...
  return (
    ...
    >
      ...
      <p className="lead">
        ...
        воєнного стану, допомога захисникам та захисницям на передовій, а також
        їхнім родинам
      </p>
      ...
      <ul className="flex flex-col gap-1">
        <li>Регулярні виїзди на території України, де ведуться бойові дії</li>
      ...
      <ul className="flex flex-col gap-1">
        ...
        <li>Навідуємо поранених у госпіталях та надаємо їм підтримку</li>
        <li>Надаємо духовну підтримку та молитовний супровід воїнам</li>
      </ul>
      <h3 className="text-2xl font-semibold mt-4 mb-4">
